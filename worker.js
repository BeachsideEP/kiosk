...
export default {
  async fetch(request, env) {
    ...
    // Serve the kiosk HTML for root requests
    if (url.pathname === '/' || url.pathname === '/index.html') {
      return fetch('https://beachsideep.github.io/kiosk/index.html');
    }
    ...
    if (url.pathname === '/api/cliniko') {
      ...
      if (action === 'search_patients') {
        ...
        clinikoUrl = CLINIKO_BASE + '/patients?q[]=last_name~~' + encodeURIComponent(lastName) + '&per_page=50';
